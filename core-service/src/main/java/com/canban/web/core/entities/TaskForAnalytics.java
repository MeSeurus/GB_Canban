...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "tasks_for_analytics")
public class TaskForAnalytics {
    @Id
    ...
    public TaskForAnalytics(Long taskId, String taskTitle, String taskUserCreator, String taskUserExecutor, LocalDateTime taskBeginDate, LocalDateTime taskEndDate, LocalDateTime taskActualEndDate, State taskState, Priority taskPriority, Long taskKanbanBoardId) {
        this.taskId = taskId;
